            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.3L0.jpg"
                                        alt=" First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.3L1.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.3L2.jpg"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.3L3.jpg"
                                        alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="text-center">
                        <h1 class="display-1 text-center">Toyota YARIS 1.3L</h1>
                        <div class="mt-5">
                            <p class="lead text-muted">The Toyota Yaris (XP130), which is based on the XP110 series
                                Vios, is a subcompact car produced and sold by Toyota since
                                2013. It made its public debut at the 15th Auto Shanghai in April 2013. It was first
                                launched for some Asian markets
                                that include China, Taiwan, Southeast Asia and the Middle East. The XP130 series Yaris
                                hatchback is larger and longer
                                than the unrelated XP110 series Vitz or Yaris Liftback, which is sold in Japan, North
                                America, Europe and Australasia.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table tabledark chasis table-striped table-hover table-bordered">
                        <tbody class="text-center table_heading text-light">
                            <tr>
                                ...
                                <td>:</td>
                                <?php
                                  $table_01 = "SELECT * FROM cardetails WHERE ID = 51;";
