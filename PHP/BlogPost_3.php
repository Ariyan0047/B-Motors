            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Camry.jpg"
                                        alt=" First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Camry1.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Camry2.jpg"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/LC2003.jpg" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="text-center">
                        <h1 class="display-1 text-center">TOYOTA Camry</h1>
                        <div class="mt-5">
                            <p class="lead text-muted">The Toyota Camry (/ˈkæmri/; Japanese: トヨタ・カムリ Toyota Kamuri) is
                                an automobile sold internationally by the Japanese manufacturer Toyota since 1982,
                                spanning multiple generations. Originally compact in size (narrow-body), later Camry
                                models have grown to fit the mid-size classification (wide-body)—although the two sizes
                                co-existed in the 1990s. Since the release of the wide-bodied versions, Camry has been
                                extolled by Toyota as the firm's second "world car" after the Corolla. In Japan, Camry
                                is exclusive to Toyota Corolla Store retail dealerships. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table tabledark chasis table-striped table-hover table-bordered">
                        <tbody class="text-center table_heading text-light">
                            <tr>
                                ...
                                <td>:</td>
                                <?php
                                  $table_01 = "SELECT * FROM cardetails WHERE ID = 49;";
