            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Hilux.jpg"
                                        alt=" First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Hilux1.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Hilux2.jpg"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/Toyota Hilux3.jpg"
                                        alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="text-center">
                        <h1 class="display-1 text-center">Toyota Hilux</h1>
                        <div class="mt-5">
                            <p class="lead text-muted">The Toyota Hilux (Japanese: トヨタ・ハイラックス, Toyota Hairakkusu)
                                (stylized as HiLux and historically as Hi-Lux) is a series of light commercial vehicles
                                produced and marketed by the Japanese automobile manufacturer Toyota. The majority of
                                these vehicles were sold as pickup truck or cab chassis variants, although they could be
                                configured in a variety of body styles. The pickup truck was sold with the HiLux name in
                                most markets, but in North America, the Hilux name was retired in 1976 in favor of
                                Truck, Pickup Truck, or Compact Truck.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table tabledark chasis table-striped table-hover table-bordered">
                        <tbody class="text-center table_heading text-light">
                            <tr>
                                ...
                                <td>:</td>
                                <?php
                                  $table_01 = "SELECT * FROM cardetails WHERE ID = 50;";
