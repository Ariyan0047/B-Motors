            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block  img-fluid newimg" src="../IMG/LC200.jpg" alt=" First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/LC2001.jpg" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/LC2002.jpg" alt="Third slide">
                                </div>
                                <div class="carousel-item">
                ...
                <div class="col-md-6">
                    <div class="text-center">
                        <h1 class="display-1 text-center">TOYOTA LC200</h1>
                        <div class="mt-5">
                            <p class="lead text-muted">The Toyota Land Cruiser (Japanese: トヨタ・ランドクルーザー, Toyota
                                Rando-Kurūzā) is a series of four-wheel drive vehicles produced by the Japanese
                                automobile manufacturer Toyota. It is Toyota's longest running series of models and the
                                2nd longest SUV in production behind the Chevrolet Suburban.As of 2019, the sales of
                                the Land Cruiser totalled more than 10 million units worldwide.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table tabledark chasis table-striped table-hover table-bordered">
                        <tbody class="text-center table_heading text-light">
                            <tr>
                                ...
                                <td>:</td>
                                <?php
                                  $table_01 = "SELECT * FROM cardetails WHERE ID = 48;";
