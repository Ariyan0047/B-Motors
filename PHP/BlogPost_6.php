            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.5L.jpg"
                                        alt=" First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.5L1.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.5L2.jpg"
                                        alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block  img-fluid newimg" src="../IMG/YARIS 1.5L3.jpg"
                                        alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="text-center">
                        <h1 class="display-1 text-center">Toyota YARIS 1.5L</h1>
                        <div class="mt-5">
                            <p class="lead text-muted">The Toyota Yaris (XP130), which is based on the XP130 series
                                ...
                                that include China, Taiwan, Southeast Asia and the Middle East. The XP150 series Yaris
                                hatchback is larger and longer
                                than the unrelated XP130 series Vitz or Yaris Liftback, which is sold in Japan, North
                    ...
                    <table class="table tabledark chasis table-striped table-hover table-bordered">
                        <tbody class="text-center table_heading text-light">
                            <tr>
                                ...
                                <td>:</td>
                                <?php
                                  $table_01 = "SELECT * FROM cardetails WHERE ID = 52;";
